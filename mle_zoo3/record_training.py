...
from mle_zoo3.utils import ALGOS, get_latest_run_id
...
if __name__ == "__main__":
    ...
    if os.path.exists(os.path.join(log_path, f"{env_name}.zip")):
        return_code = subprocess.call(["python", "-m", "mle_zoo3.record_video", *args_final_model])
    ...
    if os.path.exists(os.path.join(log_path, "best_model.zip")):
        ...
        return_code = subprocess.call(["python", "-m", "mle_zoo3.record_video", *args_best_model])
    ...
    for checkpoint in checkpoints:
        ...
        return_code = subprocess.call(["python", "-m", "mle_zoo3.record_video", *args_checkpoint])
